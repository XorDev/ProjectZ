/// @description mbuff_create_flat_tangents(modelBuffer, bytesPerVert)
/// @param modelBuffer
/// @param bytesPerVert
/*
	...
	www.TheSnidr.com
*/
var mBuff, bytesPerVert, bufferSize, i, P0, P1, P2, P3, P4, P5, P6, P7, P8, N0, N1, N2, N3, N4, N5, N6, N7, N8, T0, T1, T2, T3, T4, T5, l, p1x, p1y, p1z, p2x, p2y, p2z, s1, s2, t1, t2, r, sdx, sdy, sdz, tdx, tdy, tdz, dp, Tx, Ty, Tz, Th;
mBuff = argument0;
...
for (i = 0; i < bufferSize; i += 3 * bytesPerVert)
{
	...
	buffer_seek(mBuff, buffer_seek_start, i + 8 * 4);
	buffer_write(mBuff, buffer_u8, (Tx + 1.0) * 127);
	buffer_write(mBuff, buffer_u8, (Ty + 1.0) * 127);
	buffer_write(mBuff, buffer_u8, (Tz + 1.0) * 127);
	buffer_write(mBuff, buffer_u8, (Th + 1.0) * 127);
	...
	buffer_seek(mBuff, buffer_seek_start, i + bytesPerVert + 8 * 4);
	buffer_write(mBuff, buffer_u8, (Tx + 1.0) * 127);
	buffer_write(mBuff, buffer_u8, (Ty + 1.0) * 127);
	buffer_write(mBuff, buffer_u8, (Tz + 1.0) * 127);
	buffer_write(mBuff, buffer_u8, (Th + 1.0) * 127);
	...
	buffer_seek(mBuff, buffer_seek_start, i + 2 * bytesPerVert + 8 * 4);
	buffer_write(mBuff, buffer_u8, (Tx + 1.0) * 127);
	buffer_write(mBuff, buffer_u8, (Ty + 1.0) * 127);
	buffer_write(mBuff, buffer_u8, (Tz + 1.0) * 127);
	buffer_write(mBuff, buffer_u8, (Th + 1.0) * 127);

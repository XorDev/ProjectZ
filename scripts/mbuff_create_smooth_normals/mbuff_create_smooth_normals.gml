/// @description mbuff_create_smooth_normals(mbuff, bytesPerVert)
/// @param mbuff
/// @param bytesPerVert
/*
	...
	www.TheSnidr.com
*/
var mBuff, bytesPerVert, bufferSize, i, P0, P1, P2, P3, P4, P5, P6, P7, P8, x1, y1, z1, x2, y2, z2, Nx, Ny, Nz, l, normalMap, key, N;
mBuff = argument0;
...
for (i = 0; i < bufferSize; i += bytesPerVert)
{
	...
	key = string(P0) + "," + string(P1) + "," + string(P2);
	N = normalMap[? key];
	l = sqrt(sqr(N[0]) + sqr(N[1]) + sqr(N[2]));
	if l <= 0{continue;}
	l = 1 / l;

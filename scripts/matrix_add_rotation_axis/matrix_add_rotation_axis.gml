...
/// @arg xa the x component of the transform vector
/// @arg ya the y component of the transform vector
/// @arg za the z component of the transform vector
/// @arg angle the angle to rotate the transform through the vector
/// @arg matrix
...
return matrix_multiply( argument4, mT );